...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'Real-time chat application with features like messaging, group chats, and user authentication.',
      github: 'https://github.com/10viraj/Mychat',
    ...
    {
      title: 'My-Portfolio',
      description: 'A modern, responsive personal portfolio website built with React to showcase my software development projects, technical skills, and professional experience.',
      github: 'https://github.com/10viraj/Portfolio',
      technologies: ['React', 'React-icons', 'Tailwind CSS'],
